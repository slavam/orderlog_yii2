...
b[K];D=j(B,H+K);D=c.p.idPrefix+D;k=e===0?0:e+1;P=(k+K)%2==1?E:"";var ba=A.length;A.push("");C&&A.push(t(0,K,c.p.page,c.p.rowNum));o&&A.push(r(D,C,K));q&&A.push(a(c).jqGrid("addSubGridCell",o+C,K+e));if(l.repeatitems){y||(y=F(o+q+C));var V=a.jgrid.getXmlData(B,l.cell,true);a.each(y,function(a){var b=V[this];if(!b)return false;p=b.textContent||b.text;x[c.p.colModel[a+o+q+C].name]=p;A.push(s(D,p,a+o+q+C,K+e,B))})}else for(k=0;k<J.length;k++){p=a.jgrid.getXmlData(B,J[k]);x[c.p.colModel[k+o+q+C].name]=
p;A.push(s(D,p,k+o+q+C,K+e,B))}A[ba]=z(D,I,P,x,B);A.push("</tr>");if(c.p.grouping){N=a(c).jqGrid("groupingPrepare",A,N,x,K);A=[]}if(i||c.p.treeGrid===true){x._id_=D;c.p.data.push(x);c.p._index[D]=c.p.data.length-1}if(c.p.gridview===false){a("tbody:first",d).append(A.join(""));a(c).triggerHandler("jqGridAfterInsertRow",[D,x,B]);g&&c.p.afterInsertRow.call(c,D,x,B);A=[]}x={};m++;K++;if(m==G)break}}if(c.p.gridview===true){n=c.p.treeANode>-1?c.p.treeANode:0;if(c.p.grouping){a(c).jqGrid("groupingRender",
...
l+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';q++});l+="]}";a.extend(b.p.postData,{filters:l});a.each(["searchField","searchString","searchOper"],function(a,c){b.p.postData.hasOwnProperty(c)&&delete b.p.postData[c]})}else a.extend(b.p.postData,c);var o;b.p.searchurl&&(o=b.p.url,a(b).jqGrid("setGridParam",{url:b.p.searchurl}));var s="stop"===a(b).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!s&&a.isFunction(d.beforeSearch)&&(s=d.beforeSearch.call(b));s||a(b).jqGrid("setGridParam",
...
function(a){return k(this,a,"jqmShow")};a.fn.jqmShow=function(b){return this.each(function(){a.jqm.open(this._jqm,b)})};a.fn.jqmHide=function(b){return this.each(function(){a.jqm.close(this._jqm,b)})};a.jqm={hash:{},open:function(d,g){var k=e[d],l=k.c,j="."+l.closeClass,o=parseInt(k.w.css("z-index")),o=0<o?o:3E3,s=a("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":o-1,opacity:l.overlay/100});if(k.a)return c;k.t=g;k.a=!0;k.w.css("z-index",o);l.modal?(b[0]||setTimeout(function(){i("bind")},
1),b.push(d)):0<l.overlay?l.closeoverlay&&k.w.jqmAddClose(s):s=c;k.o=s?s.addClass(l.overlayClass).prependTo("body"):c;if(f&&(a("html,body").css({height:"100%",width:"100%"}),s)){var s=s.css({position:"absolute"})[0],r;for(r in{Top:1,Left:1})s.style.setExpression(r.toLowerCase(),"(_=(document.documentElement.scroll"+r+" || document.body.scroll"+r+"))+'px'")}l.ajax?(o=l.target||k.w,s=l.ajax,o="string"==typeof o?a(o,k.w):a(o),s="@"==s.substr(0,1)?a(g).attr(s.substring(1)):s,o.html(l.ajaxText).load(s,
...
a("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>"),h="left";"rtl"==this.p.direction&&(h="right",g.attr("dir","rtl"));null===c&&g.append("<tr class='error' style='display:none;'><th colspan='5' class='ui-state-error' align='"+h+"'></th></tr>");var i=a("<tr></tr>");g.append(i);h=a("<th colspan='5' align='"+h+"'></th>");i.append(h);if(!0===this.p.ruleButtons){var j=a("<select class='opsel'></select>");h.append(j);var i="",r;for(e=0;e<f.groupOps.length;e++)r=
b.groupOp===d.p.groupOps[e].op?" selected='selected'":"",i+="<option value='"+d.p.groupOps[e].op+"'"+r+">"+d.p.groupOps[e].text+"</option>";j.append(i).bind("change",function(){b.groupOp=a(j).val();d.onchange()})}i="<span></span>";this.p.groupButton&&(i=a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"),i.bind("click",function(){if(b.groups===void 0)b.groups=[];b.groups.push({groupOp:f.groupOps[0].op,rules:[],groups:[]});d.reDraw();d.onchange();return false}));h.append(i);
...
b)),h.append(i);void 0===b.groupOp&&(b.groupOp=d.p.groupOps[0].op);if(void 0!==b.rules)for(e=0;e<b.rules.length;e++)g.append(this.createTableRowForRule(b.rules[e],b));return g};this.createTableRowForRule=function(b,c){var d=this,e=a("<tr></tr>"),g,h,j,s,r="",t;e.append("<td class='first'></td>");var v=a("<td class='columns'></td>");e.append(v);var F=a("<select></select>"),w,x=[];v.append(F);F.bind("change",function(){b.field=a(F).val();j=a(this).parents("tr:first");for(g=0;g<d.p.columns.length;g++)if(d.p.columns[g].name===
b.field){s=d.p.columns[g];break}if(s){s.searchoptions.id=a.jgrid.randId();i&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var c=a.jgrid.createEl(s.inputtype,s.searchoptions,"",!0,d.p.ajaxSelectOptions,!0);a(c).addClass("input-elm");h=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===s.searchtype?d.p.stropts:d.p.numopts;var e="",f=0;x=[];a.each(d.p.ops,function(){x.push(this.name)});for(g=0;g<h.length;g++)w=a.inArray(h[g],x),-1!==w&&(0===f&&(b.op=d.p.ops[w].name),
...
"SPAN"&&s.searchoptions&&a.isFunction(s.searchoptions.custom_value)?s.searchoptions.custom_value(a(e).children(".customelement:first"),"get"):e.value;d.onchange()},e)});setTimeout(function(){b.data=a(c).val();d.onchange()},0)}});for(g=v=0;g<d.p.columns.length;g++){t="undefined"===typeof d.p.columns[g].search?!0:d.p.columns[g].search;var z=!0===d.p.columns[g].hidden;if(!0===d.p.columns[g].searchoptions.searchhidden&&t||t&&!z)t="",b.field===d.p.columns[g].name&&(t=" selected='selected'",v=g),r+="<option value='"+
d.p.columns[g].name+"'"+t+">"+d.p.columns[g].label+"</option>"}F.append(r);r=a("<td class='operators'></td>");e.append(r);s=f.columns[v];s.searchoptions.id=a.jgrid.randId();i&&"text"===s.inputtype&&!s.searchoptions.size&&(s.searchoptions.size=10);var v=a.jgrid.createEl(s.inputtype,s.searchoptions,b.data,!0,d.p.ajaxSelectOptions,!0),y=a("<select class='selectopts'></select>");r.append(y);y.bind("change",function(){b.op=a(y).val();j=a(this).parents("tr:first");var c=a(".input-elm",j)[0];if(b.op==="nu"||
b.op==="nn"){b.data="";c.value="";c.setAttribute("readonly","true");c.setAttribute("disabled","true")}else{c.removeAttribute("readonly");c.removeAttribute("disabled")}d.onchange()});h=s.searchoptions.sopt?s.searchoptions.sopt:d.p.sopt?d.p.sopt:"string"===s.searchtype?f.stropts:d.p.numopts;r="";a.each(d.p.ops,function(){x.push(this.name)});for(g=0;g<h.length;g++)w=a.inArray(h[g],x),-1!==w&&(t=b.op===d.p.ops[w].name?" selected='selected'":"",r+="<option value='"+d.p.ops[w].name+"'"+t+">"+d.p.ops[w].description+
"</option>");y.append(r);r=a("<td class='data'></td>");e.append(r);r.append(v);a(v).addClass("input-elm").bind("change",function(){b.data=s.inputtype==="custom"?s.searchoptions.custom_value(a(this).children(".customelement:first"),"get"):a(this).val();d.onchange()});r=a("<td></td>");e.append(r);!0===this.p.ruleButtons&&(v=a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"),r.append(v),v.bind("click",function(){for(g=0;g<c.rules.length;g++)if(c.rules[g]===b){c.rules.splice(g,
...
d.Reset+"</a>",q="",o="",s,r=!1,t=-1;d.showQuery&&(q="<a href='javascript:void(0)' id='"+c+"_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>");d.columns.length?n=d.columns:a.each(n,function(a,b){if(!b.label)b.label=f.p.colNames[a];if(!r){var c=typeof b.search==="undefined"?true:b.search,d=b.hidden===true;if(b.searchoptions&&b.searchoptions.searchhidden===true&&c||c&&!d){r=true;s=b.index||b.name;t=a}}});if(!i&&s||!1===
d.multipleSearch){var v="eq";0<=t&&n[t].searchoptions&&n[t].searchoptions.sopt?v=n[t].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(v=d.sopt[0]);i={groupOp:"AND",rules:[{field:s,op:v,data:""}]}}r=!1;d.tmplNames&&d.tmplNames.length&&(r=!0,o=d.tmplLabel,o+="<select class='ui-template'>",o+="<option value='default'>Default</option>",a.each(d.tmplNames,function(a,b){o=o+("<option value='"+a+"'>"+b+"</option>")}),o+="</select>");k="<table class='EditTable' style='border:0px none;margin-top:5px' id='"+
...
groupOps:d.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());a.isFunction(d.afterChange)&&d.afterChange.call(f,a("#"+c),d)},direction:f.p.direction});j.append(k);r&&d.tmplFilters&&d.tmplFilters.length&&a(".ui-template",j).bind("change",function(){var b=a(this).val();b=="default"?a("#"+c).jqFilter("addFilter",i):a("#"+c).jqFilter("addFilter",d.tmplFilters[parseInt(b,10)]);return false});!0===d.multipleGroup&&(d.multipleSearch=!0);a(f).triggerHandler("jqGridFilterInitialize",
...
_savedData:{},processing:!1,onClose:null,ajaxEditOptions:{},serializeEditData:null,viewPagerButtons:!0},a.jgrid.edit,b||{});d[a(this)[0].p.id]=b;return this.each(function(){function f(){a(r+" > tbody > tr > td > .FormElement").each(function(){var b=a(".customelement",this);if(b.length){var c=a(b[0]).attr("name");a.each(l.p.colModel,function(){if(this.name===c&&this.editoptions&&a.isFunction(this.editoptions.custom_value)){try{if(u[c]=this.editoptions.custom_value.call(l,a("#"+a.jgrid.jqID(c),r),"get"),
...
this).text();break;case "select-multiple":u[this.name]=a(this).val();u[this.name]=u[this.name]?u[this.name].join(","):"";var d=[];a("option:selected",this).each(function(b,c){d[b]=a(c).text()});H[this.name]=d.join(",");break;case "password":case "text":case "textarea":case "button":u[this.name]=a(this).val()}l.p.autoencode&&(u[this.name]=a.jgrid.htmlEncode(u[this.name]))}});return!0}function c(b,c,e,f){var g,h,i,j=0,k,n,m,o=[],p=!1,s="",r;for(r=1;r<=f;r++)s+="<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>";
"_empty"!=b&&(p=a(c).jqGrid("getInd",b));a(c.p.colModel).each(function(r){g=this.name;n=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";if("cb"!==g&&"subgrid"!==g&&!0===this.editable&&"rn"!==g){if(!1===p)k="";else if(g==c.p.ExpandColumn&&!0===c.p.treeGrid)k=a("td:eq("+r+")",c.rows[p]).text();else{try{k=a.unformat.call(c,a("td:eq("+r+")",c.rows[p]),{rowId:b,colModel:this},r)}catch(q){k=this.edittype&&"textarea"==this.edittype?a("td:eq("+r+")",
c.rows[p]).text():a("td:eq("+r+")",c.rows[p]).html()}if(!k||"&nbsp;"==k||"&#160;"==k||1==k.length&&160==k.charCodeAt(0))k=""}var t=a.extend({},this.editoptions||{},{id:g,name:g}),v=a.extend({},{elmprefix:"",elmsuffix:"",rowabove:!1,rowcontent:""},this.formoptions||{}),z=parseInt(v.rowpos,10)||j+1,u=parseInt(2*(parseInt(v.colpos,10)||1),10);"_empty"==b&&t.defaultValue&&(k=a.isFunction(t.defaultValue)?t.defaultValue.call(l):t.defaultValue);this.edittype||(this.edittype="text");l.p.autoencode&&(k=a.jgrid.htmlDecode(k));
...
2*f+"'>"+v.rowcontent+"</td></tr>"),a(e).append(t),t[0].rp=z);0===i.length&&(i=a("<tr "+n+" rowpos='"+z+"'></tr>").addClass("FormData").attr("id","tr_"+g),a(i).append(s),a(e).append(i),i[0].rp=z);a("td:eq("+(u-2)+")",i[0]).html("undefined"===typeof v.label?c.p.colNames[r]:v.label);a("td:eq("+(u-1)+")",i[0]).append(v.elmprefix).append(m).append(v.elmsuffix);o[j]=r;j++}});if(0<j&&(r=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='"+
c.p.id+"_id' value='"+b+"'/></td></tr>"),r[0].rp=j+999,a(e).append(r),d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate))d[l.p.id]._savedData[c.p.id+"_id"]=b;return o}function h(b,c,e){var f,g=0,h,i,j,k,n;if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)d[l.p.id]._savedData={},d[l.p.id]._savedData[c.p.id+"_id"]=b;var m=c.p.colModel;if("_empty"==b)a(m).each(function(){f=this.name;j=a.extend({},this.editoptions||{});if((i=a("#"+a.jgrid.jqID(f),"#"+e))&&i.length&&null!==i[0])if(k="",j.defaultValue?
...
a.jgrid.info_dialog(jQuery.jgrid.errors.errcap,n.message,jQuery.jgrid.edit.bClose)}}g++}}),0<g&&a("#id_g",r).val(b))}}function g(){a.each(l.p.colModel,function(a,b){b.editoptions&&!0===b.editoptions.NullIfEmpty&&u.hasOwnProperty(b.name)&&""===u[b.name]&&(u[b.name]="null")})}function i(){var c,e=[!0,"",""],f={},i=l.p.prmNames,j,k,n,m,p,s=a(l).triggerHandler("jqGridAddEditBeforeCheckValues",[a("#"+o),I]);s&&"object"===typeof s&&(u=s);a.isFunction(d[l.p.id].beforeCheckValues)&&(s=d[l.p.id].beforeCheckValues.call(l,
u,a("#"+o),"_empty"==u[l.p.id+"_id"]?i.addoper:i.editoper))&&"object"===typeof s&&(u=s);for(n in u)if(u.hasOwnProperty(n)&&(e=a.jgrid.checkValues.call(l,u[n],n,l),!1===e[0]))break;g();e[0]&&(f=a(l).triggerHandler("jqGridAddEditClickSubmit",[d[l.p.id],u,I]),void 0===f&&a.isFunction(d[l.p.id].onclickSubmit)&&(f=d[l.p.id].onclickSubmit.call(l,d[l.p.id],u)||{}),e=a(l).triggerHandler("jqGridAddEditBeforeSubmit",[u,a("#"+o),I]),void 0===e&&(e=[!0,"",""]),e[0]&&a.isFunction(d[l.p.id].beforeSubmit)&&(e=d[l.p.id].beforeSubmit.call(l,
...
d[l.p.id].errorTextFormat.call(l,f):g+" Status: '"+f.statusText+"'. Error code: "+f.status}else{e=a(l).triggerHandler("jqGridAddEditAfterSubmit",[f,u,I]);e===void 0&&(e=[true,"",""]);e[0]&&a.isFunction(d[l.p.id].afterSubmit)&&(e=d[l.p.id].afterSubmit.call(l,f,u))}if(e[0]===false){a("#FormError>td",r).html(e[1]);a("#FormError",r).show()}else{a.each(l.p.colModel,function(){if(H[this.name]&&this.formatter&&this.formatter=="select")try{delete H[this.name]}catch(a){}});u=a.extend(u,H);l.p.autoencode&&
...
"_empty")for(var n in d[l.p.id]._savedData)u[n]&&(d[l.p.id]._savedData[n]=u[n])}}d[l.p.id].processing=false;a("#sData",r+"_2").removeClass("ui-state-active");try{a(":input:visible","#"+o)[0].focus()}catch(p){}}},a.jgrid.ajaxOptions,d[l.p.id].ajaxEditOptions);!p.url&&!d[l.p.id].useDataProxy&&(a.isFunction(l.p.dataProxy)?d[l.p.id].useDataProxy=!0:(e[0]=!1,e[1]+=" "+a.jgrid.errors.nourl));e[0]&&(d[l.p.id].useDataProxy?(f=l.p.dataProxy.call(l,p,"set_"+l.p.id),"undefined"==typeof f&&(f=[!0,""]),!1===f[0]?
(e[0]=!1,e[1]=f[1]||"Error deleting the selected row!"):(p.data.oper==i.addoper&&d[l.p.id].closeAfterAdd&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose}),p.data.oper==i.editoper&&d[l.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose}))):a.ajax(p))}!1===e[0]&&(a("#FormError>td",r).html(e[1]),a("#FormError",r).show())}function j(a,b){var c=!1,
d;for(d in a)if(a[d]!=b[d]){c=!0;break}return c}function k(){var b=!0;a("#FormError",r).hide();if(d[l.p.id].checkOnUpdate&&(u={},H={},f(),Q=a.extend({},u,H),O=j(Q,d[l.p.id]._savedData)))a("#"+o).data("disabled",!0),a(".confirm","#"+t.themodal).show(),b=!1;return b}function m(){if("_empty"!==e&&"undefined"!==typeof l.p.savedRow&&0<l.p.savedRow.length&&a.isFunction(a.fn.jqGrid.restoreRow))for(var b=0;b<l.p.savedRow.length;b++)if(l.p.savedRow[b].id==e){a(l).jqGrid("restoreRow",e);break}}function n(b,
c){0===b?a("#pData",r+"_2").addClass("ui-state-disabled"):a("#pData",r+"_2").removeClass("ui-state-disabled");b==c?a("#nData",r+"_2").addClass("ui-state-disabled"):a("#nData",r+"_2").removeClass("ui-state-disabled")}function p(){var b=a(l).jqGrid("getDataIDs"),c=a("#id_g",r).val();return[a.inArray(c,b),b]}var l=this;if(l.grid&&e){var q=l.p.id,o="FrmGrid_"+q,s="TblGrid_"+q,r="#"+a.jgrid.jqID(s),t={themodal:"editmod"+q,modalhead:"edithd"+q,modalcontent:"editcnt"+q,scrollelm:o},v=a.isFunction(d[l.p.id].beforeShowForm)?
...
b.checkOnUpdate&&b.jqModal&&!b.modal&&(Y=!1);if(null!==a("#"+a.jgrid.jqID(t.themodal)).html()){z=a(l).triggerHandler("jqGridAddEditBeforeInitData",[a("#"+a.jgrid.jqID(o))]);"undefined"==typeof z&&(z=!0);z&&w&&(z=w.call(l,a("#"+o)));if(!1===z)return;m();a(".ui-jqdialog-title","#"+a.jgrid.jqID(t.modalhead)).html(b.caption);a("#FormError",r).hide();d[l.p.id].topinfo?(a(".topinfo",r).html(d[l.p.id].topinfo),a(".tinfo",r).show()):a(".tinfo",r).hide();d[l.p.id].bottominfo?(a(".bottominfo",r+"_2").html(d[l.p.id].bottominfo),
a(".binfo",r+"_2").show()):a(".binfo",r+"_2").hide();h(e,l,o);"_empty"==e||!d[l.p.id].viewPagerButtons?a("#pData, #nData",r+"_2").hide():a("#pData, #nData",r+"_2").show();!0===d[l.p.id].processing&&(d[l.p.id].processing=!1,a("#sData",r+"_2").removeClass("ui-state-active"));!0===a("#"+o).data("disabled")&&(a(".confirm","#"+a.jgrid.jqID(t.themodal)).hide(),a("#"+o).data("disabled",!1));a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+o),I]);v&&v.call(l,a("#"+o));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",
...
(w?W+z:z+W)+"</td><td class='EditButton'>"+aa+L+"</td></tr>"+("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>"+d[l.p.id].bottominfo+"</td></tr>"),s=s+"</tbody></table>";if(0<A){var $=[];a.each(a(U)[0].rows,function(a,b){$[a]=b});$.sort(function(a,b){return a.rp>b.rp?1:a.rp<b.rp?-1:0});a.each($,function(b,c){a("tbody",U).append(c)})}b.gbox="#gbox_"+a.jgrid.jqID(q);var S=!1;!0===b.closeOnEscape&&(b.closeOnEscape=!1,S=!0);s=a("<span></span>").append(Z).append(s);a.jgrid.createModal(t,
s,b,"#gview_"+a.jgrid.jqID(l.p.id),a("#gbox_"+a.jgrid.jqID(l.p.id))[0]);w&&(a("#pData, #nData",r+"_2").css("float","right"),a(".EditButton",r+"_2").css("text-align","left"));d[l.p.id].topinfo&&a(".tinfo",r).show();d[l.p.id].bottominfo&&a(".binfo",r+"_2").show();s=s=null;a("#"+a.jgrid.jqID(t.themodal)).keydown(function(c){var e=c.target;if(a("#"+o).data("disabled")===true)return false;if(d[l.p.id].savekey[0]===true&&c.which==d[l.p.id].savekey[1]&&e.tagName!="TEXTAREA"){a("#sData",r+"_2").trigger("click");
return false}if(c.which===27){if(!k())return false;S&&a.jgrid.hideModal(this,{gb:b.gbox,jqm:b.jqModal,onClose:d[l.p.id].onClose});return false}if(d[l.p.id].navkeys[0]===true){if(a("#id_g",r).val()=="_empty")return true;if(c.which==d[l.p.id].navkeys[1]){a("#pData",r+"_2").trigger("click");return false}if(c.which==d[l.p.id].navkeys[2]){a("#nData",r+"_2").trigger("click");return false}}});b.checkOnUpdate&&(a("a.ui-jqdialog-titlebar-close span","#"+a.jgrid.jqID(t.themodal)).removeClass("jqmClose"),a("a.ui-jqdialog-titlebar-close",
"#"+a.jgrid.jqID(t.themodal)).unbind("click").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false}));b.saveicon=a.extend([!0,"left","ui-icon-disk"],b.saveicon);b.closeicon=a.extend([!0,"left","ui-icon-close"],b.closeicon);!0===b.saveicon[0]&&a("#sData",r+"_2").addClass("right"==b.saveicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.saveicon[2]+
"'></span>");!0===b.closeicon[0]&&a("#cData",r+"_2").addClass("right"==b.closeicon[1]?"fm-button-icon-right":"fm-button-icon-left").append("<span class='ui-icon "+b.closeicon[2]+"'></span>");if(d[l.p.id].checkOnSubmit||d[l.p.id].checkOnUpdate)aa="<a href='javascript:void(0)' id='sNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bYes+"</a>",W="<a href='javascript:void(0)' id='nNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>"+b.bNo+"</a>",L=
...
a.jgrid.jqID(t.themodal)).hide();a("#"+o).data("disabled",false);a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,onClose:d[l.p.id].onClose});return false});a(l).triggerHandler("jqGridAddEditInitializeForm",[a("#"+o),I]);x&&x.call(l,a("#"+o));"_empty"==e||!d[l.p.id].viewPagerButtons?a("#pData,#nData",r+"_2").hide():a("#pData,#nData",r+"_2").show();a(l).triggerHandler("jqGridAddEditBeforeShowForm",[a("#"+o),I]);v&&v.call(l,a("#"+o));a("#"+a.jgrid.jqID(t.themodal)).data("onClose",
...
function(){a(this).removeClass("ui-state-hover")});a("#sData",r+"_2").click(function(){u={};H={};a("#FormError",r).hide();f();if(u[l.p.id+"_id"]=="_empty")i();else if(b.checkOnSubmit===true){Q=a.extend({},u,H);if(O=j(Q,d[l.p.id]._savedData)){a("#"+o).data("disabled",true);a(".confirm","#"+a.jgrid.jqID(t.themodal)).show()}else i()}else i();return false});a("#cData",r+"_2").click(function(){if(!k())return false;a.jgrid.hideModal("#"+a.jgrid.jqID(t.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:b.jqModal,
onClose:d[l.p.id].onClose});return false});a("#nData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var c=p();c[0]=parseInt(c[0],10);if(c[0]!=-1&&c[1][c[0]+1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["next",a("#"+o),c[1][c[0]]]);a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(l,"next",a("#"+o),c[1][c[0]]);h(c[1][c[0]+1],l,o);a(l).jqGrid("setSelection",c[1][c[0]+1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",["next",a("#"+o),c[1][c[0]]]);a.isFunction(b.afterclickPgButtons)&&
b.afterclickPgButtons.call(l,"next",a("#"+o),c[1][c[0]+1]);n(c[0]+1,c[1].length-1)}return false});a("#pData",r+"_2").click(function(){if(!k())return false;a("#FormError",r).hide();var c=p();if(c[0]!=-1&&c[1][c[0]-1]){a(l).triggerHandler("jqGridAddEditClickPgButtons",["prev",a("#"+o),c[1][c[0]]]);a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(l,"prev",a("#"+o),c[1][c[0]]);h(c[1][c[0]-1],l,o);a(l).jqGrid("setSelection",c[1][c[0]-1]);a(l).triggerHandler("jqGridAddEditAfterClickPgButtons",
...
a(d.p.colModel).each(function(){h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1;!h&&"right"===this.align&&(this.formatter&&-1!==a.inArray(this.formatter,s)?r=Math.max(r,parseInt(this.width,10)):t=Math.max(t,parseInt(this.width,10)))});q=0!==r?r:0!==t?t:0;m=a(d).jqGrid("getInd",c);a(d.p.colModel).each(function(b){g=this.name;v=!1;k=(h=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";x="boolean"!=typeof this.viewable?!0:this.viewable;
...
d){var k=j.p.id,m="ViewGrid_"+a.jgrid.jqID(k),n="ViewTbl_"+a.jgrid.jqID(k),p="ViewGrid_"+k,l="ViewTbl_"+k,q={themodal:"viewmod"+k,modalhead:"viewhd"+k,modalcontent:"viewcnt"+k,scrollelm:m},o=a.isFunction(b.beforeInitData)?b.beforeInitData:!1,s=!0,r=1,t=0;if(null!==a("#"+a.jgrid.jqID(q.themodal)).html()){o&&(s=o.call(j,a("#"+m)),"undefined"==typeof s&&(s=!0));if(!1===s)return;a(".ui-jqdialog-title","#"+a.jgrid.jqID(q.modalhead)).html(b.caption);a("#FormError","#"+n).hide();h(d,j);a.isFunction(b.beforeShowForm)&&
...
(s=o.call(j,a("#"+m)),"undefined"==typeof s&&(s=!0));if(!1===s)return;a(j.p.colModel).each(function(){var a=this.formoptions;r=Math.max(r,a?a.colpos||0:0);t=Math.max(t,a?a.rowpos||0:0)});a(p).append(F);c(d,j,F,r);l="rtl"==j.p.direction?!0:!1;o="<a href='javascript:void(0)' id='"+(l?"nData":"pData")+"' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></a>";s="<a href='javascript:void(0)' id='"+(l?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>";
...
b.labelswidth+"'>"+(l?s+o:o+s)+"</td><td class='EditButton'>"+v+"</td></tr></tbody></table>");a.jgrid.createModal(q,p,b,"#gview_"+a.jgrid.jqID(j.p.id),a("#gview_"+a.jgrid.jqID(j.p.id))[0]);l&&(a("#pData, #nData","#"+n+"_2").css("float","right"),a(".EditButton","#"+n+"_2").css("text-align","left"));b.viewPagerButtons||a("#pData, #nData","#"+n+"_2").hide();p=null;a("#"+q.themodal).keydown(function(c){if(c.which===27){x&&a.jgrid.hideModal(this,{gb:b.gbox,jqm:b.jqModal,onClose:b.onClose});return false}if(b.navkeys[0]===
...
jqModal:!0,closeOnEscape:!1,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},a.jgrid.del,b||{});d[a(this)[0].p.id]=b;return this.each(function(){var f=this;if(f.grid&&e){var c=a.isFunction(d[f.p.id].beforeShowForm),h=a.isFunction(d[f.p.id].afterShowForm),g=a.isFunction(d[f.p.id].beforeInitData)?d[f.p.id].beforeInitData:!1,i=f.p.id,j={},k=!0,m="DelTbl_"+a.jgrid.jqID(i),n,p,l,q,o="DelTbl_"+i,s={themodal:"delmod"+i,modalhead:"delhd"+
i,modalcontent:"delcnt"+i,scrollelm:m};jQuery.isArray(e)&&(e=e.join());if(null!==a("#"+a.jgrid.jqID(s.themodal)).html()){g&&(k=g.call(f,a("#"+m)),"undefined"==typeof k&&(k=!0));if(!1===k)return;a("#DelData>td","#"+m).text(e);a("#DelError","#"+m).hide();!0===d[f.p.id].processing&&(d[f.p.id].processing=!1,a("#dData","#"+m).removeClass("ui-state-active"));c&&d[f.p.id].beforeShowForm.call(f,a("#"+m));a.jgrid.viewModal("#"+a.jgrid.jqID(s.themodal),{gbox:"#gbox_"+a.jgrid.jqID(i),jqm:d[f.p.id].jqModal,jqM:!1,
overlay:d[f.p.id].overlay,modal:d[f.p.id].modal})}else{var r=isNaN(d[f.p.id].dataheight)?d[f.p.id].dataheight:d[f.p.id].dataheight+"px",o="<div id='"+o+"' class='formdata' style='width:100%;overflow:auto;position:relative;height:"+r+";'><table class='DelTable'><tbody><tr id='DelError' style='display:none'><td class='ui-state-error'></td></tr>"+("<tr id='DelData' style='display:none'><td >"+e+"</td></tr>"),o=o+('<tr><td class="delmsg" style="white-space:pre;">'+d[f.p.id].msg+"</td></tr><tr><td >&#160;</td></tr>"),
...
else try{e=a.unformat.call(b,this,{rowId:d,colModel:j[i]},i)}catch(m){e=j[i].edittype&&"textarea"==j[i].edittype?a(this).text():a(this).html()}if("cb"!=c&&"subgrid"!=c&&"rn"!=c&&(b.p.autoencode&&(e=a.jgrid.htmlDecode(e)),h[c]=e,!0===j[i].editable)){null===g&&(g=i);k?a("span:first",this).html(""):a(this).html("");var r=a.extend({},j[i].editoptions||{},{id:d+"_"+c,name:c});j[i].edittype||(j[i].edittype="text");if("&nbsp;"==e||"&#160;"==e||1==e.length&&160==e.charCodeAt(0))e="";r=a.jgrid.createEl.call(b,
j[i].edittype,r,e,!0,a.extend({},a.jgrid.ajaxOptions,b.p.ajaxSelectOptions||{}));a(r).addClass("editable");k?a("span:first",this).append(r):a(this).append(r);"select"==j[i].edittype&&"undefined"!==typeof j[i].editoptions&&!0===j[i].editoptions.multiple&&"undefined"===typeof j[i].editoptions.dataUrl&&a.browser.msie&&a(r).width(a(r).width());f++}}),0<f&&(h.id=d,b.p.savedRow.push(h),a(i).attr("editable","1"),a("td:eq("+g+") input",i).focus(),!0===k.keys&&a(i).bind("keydown",function(c){if(27===c.keyCode){a(b).jqGrid("restoreRow",
...
e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"==e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}s=a.jgrid.checkValues(p[n],b,m);if(!1===s[0])return s[1]=p[n]+" "+s[1],!1;m.p.autoencode&&(p[n]=a.jgrid.htmlEncode(p[n]));"clientArray"!==j.url&&t.editoptions&&!0===t.editoptions.NullIfEmpty&&
""===p[n]&&(q[n]="null")}});if(!1===s[0]){try{var v=a.jgrid.findPos(a("#"+a.jgrid.jqID(d),m.grid.bDiv)[0]);a.jgrid.info_dialog(a.jgrid.errors.errcap,s[1],a.jgrid.edit.bClose,{left:v[0],top:v[1]})}catch(F){alert(s[1])}return k}var w,i=m.p.prmNames;w=i.oper;v=i.id;p&&(p[w]=i.editoper,p[v]=d,"undefined"==typeof m.p.inlineData&&(m.p.inlineData={}),p=a.extend({},p,m.p.inlineData,j.extraparam));if("clientArray"==j.url){p=a.extend({},p,l);m.p.autoencode&&a.each(p,function(b,c){p[b]=a.jgrid.htmlDecode(c)});
v=a(m).jqGrid("setRowData",d,p);a(r).attr("editable","0");for(i=0;i<m.p.savedRow.length;i++)if(m.p.savedRow[i].id==d){o=i;break}0<=o&&m.p.savedRow.splice(o,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[d,v,p,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,d,v);k=!0;a(r).unbind("keydown")}else a("#lui_"+a.jgrid.jqID(m.p.id)).show(),q=a.extend({},p,q),q[v]=a.jgrid.stripPref(m.p.idPrefix,q[v]),a.ajax(a.extend({url:j.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,
q):q,type:j.mtype,async:!1,complete:function(b,c){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();if(c==="success"){var e=true,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",[b,d,j]);a.isArray(f)||(f=[true,p]);f[0]&&a.isFunction(j.successfunc)&&(f=j.successfunc.call(m,b));if(a.isArray(f)){e=f[0];p=f[1]?f[1]:p}else e=f;if(e===true){m.p.autoencode&&a.each(p,function(b,c){p[b]=a.jgrid.htmlDecode(c)});p=a.extend({},p,l);a(m).jqGrid("setRowData",d,p);a(r).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(m.p.savedRow[e].id==
d){o=e;break}o>=0&&m.p.savedRow.splice(o,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[d,b,p,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,d,b);k=true;a(r).unbind("keydown")}else{a(m).triggerHandler("jqGridInlineErrorSaveRow",[d,b,c,null,j]);a.isFunction(j.errorfunc)&&j.errorfunc.call(m,d,b,c,null);j.restoreAfterError===true&&a(m).jqGrid("restoreRow",d,j.afterrestorefunc)}}},error:function(b,c,e){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();a(m).triggerHandler("jqGridInlineErrorSaveRow",
...
m=f.p.treeReader.loaded,n,p,l,q,o;n=0;var s=e,r;if("undefined"===typeof d||null===d){o=f.p.data.length-1;if(0<=o)for(;0<=o;)n=Math.max(n,parseInt(f.p.data[o][f.p.localReader.id],10)),o--;d=n+1}var t=a(f).jqGrid("getInd",e);r=!1;if(void 0===e||null===e||""===e)s=e=null,n="last",q=f.p.tree_root_level,o=f.p.data.length+1;else if(n="after",p=f.p._index[e],l=f.p.data[p],e=l[f.p.localReader.id],q=parseInt(l[g],10)+1,o=a(f).jqGrid("getFullTreeNode",l),o.length?(s=o=o[o.length-1][f.p.localReader.id],o=a(f).jqGrid("getInd",
s)+1):o=a(f).jqGrid("getInd",e)+1,l[h])r=!0,l[c]=!0,a(f.rows[t]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(f.p.treeIcons.leaf+" tree-leaf").addClass(f.p.treeIcons.minus+" tree-minus"),f.p.data[p][h]=!1,l[m]=!0;p=o+1;b[c]=!1;b[m]=!0;b[g]=q;b[h]=!0;"adjacency"===f.p.treeGridModel&&(b[i]=e);if("nested"===f.p.treeGridModel){var v;if(null!==e){h=parseInt(l[k],10);g=a.jgrid.from(f.p.data);g=g.greaterOrEquals(k,h,{stype:"integer"});
...
10)+2);b[j]=h+1;b[k]=h+2}}if(null===e||a(f).jqGrid("isNodeLoaded",l)||r)a(f).jqGrid("addRowData",d,b,n,s),a(f).jqGrid("setTreeNode",o,p);l&&!l[c]&&a(f.rows[t]).find("div.treeclick").click()}}})})(jQuery);
...
2,2);var b=b.join("_"),c=e.minusicon,h=e.plusicon,g=a("#"+a.jgrid.jqID(d)),g=g.length?g[0].nextSibling:null,i=a("#"+a.jgrid.jqID(d)+" span.tree-wrap-"+this.p.direction),j=!1;if(i.hasClass(c)){if(e.showSummaryOnHide){if(g)for(;g&&!a(g).hasClass("jqfoot");)a(g).hide(),g=g.nextSibling}else if(g)for(;g&&!a(g).hasClass(b+"_"+(""+f))&&!a(g).hasClass(b+"_"+(""+(f-1)));)a(g).hide(),g=g.nextSibling;i.removeClass(c).addClass(h);j=!0}else{if(g)for(;g&&!a(g).hasClass(b+"_"+(""+f))&&!a(g).hasClass(b+"_"+(""+(f-
1)));)a(g).show(),g=g.nextSibling;i.removeClass(h).addClass(c)}a(this).triggerHandler("jqGridGroupingClickGroup",[d,j]);a.isFunction(this.p.onClickGroup)&&this.p.onClickGroup.call(this,d,j)});return!1},groupingRender:function(d,e){return this.each(function(){function b(a,b,c){if(0===b)return c[a];var d=c[a].idx;if(0===d)return c[a];for(;0<=a;a--)if(c[a].idx===d-b)return c[a]}var f=this,c=f.p.groupingView,h="",g="",i,j,k=c.groupCollapse?c.plusicon:c.minusicon,m,n=[],p=c.groupField.length,k=k+(" tree-wrap-"+
f.p.direction);a.each(f.p.colModel,function(a,b){for(var d=0;d<p;d++)if(c.groupField[d]===b.name){n[d]=a;break}});var l=0,q=a.makeArray(c.groupSummary);q.reverse();a.each(c.groups,function(o,s){l++;j=f.p.id+"ghead_"+s.idx;i=j+"_"+o;g="<span style='cursor:pointer;' class='ui-icon "+k+"' onclick=\"jQuery('#"+a.jgrid.jqID(f.p.id)+"').jqGrid('groupingToggle','"+i+"');return false;\"></span>";try{m=f.formatter(i,s.value,n[s.idx],s.value)}catch(r){m=s.value}h+='<tr id="'+i+'" role="row" class= "ui-widget-content jqgroup ui-row-'+
f.p.direction+" "+j+'"><td style="padding-left:'+12*s.idx+'px;" colspan="'+e+'">'+g+a.jgrid.template(c.groupText[s.idx],m,s.cnt,s.summary)+"</td></tr>";if(p-1===s.idx){for(var t=c.groups[o+1],v=void 0!==t?c.groups[o+1].startRow:d.length,F=s.startRow;F<v;F++)h+=d[F].join("");var w;if(void 0!==t){for(w=0;w<c.groupField.length&&t.dataIndex!==c.groupField[w];w++);l=c.groupField.length-w}for(t=0;t<l;t++)if(q[t]){v="";c.groupCollapse&&!c.showSummaryOnHide&&(v=' style="display:none;"');h+="<tr"+v+' role="row" class="ui-widget-content jqfoot ui-row-'+
f.p.direction+'">';for(var v=b(o,t,c.groups),x=f.p.colModel,z,y=v.cnt,A=0;A<e;A++){var u="<td "+f.formatCol(A,1,"")+">&#160;</td>",H="{0}";a.each(v.summary,function(){if(this.nm===x[A].name){x[A].summaryTpl&&(H=x[A].summaryTpl);"string"===typeof this.st&&"avg"===this.st.toLowerCase()&&this.v&&0<y&&(this.v/=y);try{z=f.formatter("",this.v,A,this)}catch(b){z=this.v}u="<td "+f.formatCol(A,1,"")+">"+a.jgrid.format(H,z)+"</td>";return!1}});h+=u}h+="</tr>"}l=w}});a("#"+a.jgrid.jqID(f.p.id)+" tbody:first").append(h);
h=null})},groupingGroupBy:function(d,e){return this.each(function(){"string"===typeof d&&(d=[d]);var b=this.p.groupingView;this.p.grouping=!0;"undefined"===typeof b.visibiltyOnNextGrouping&&(b.visibiltyOnNextGrouping=[]);var f;for(f=0;f<b.groupField.length;f++)!b.groupColumnShow[f]&&b.visibiltyOnNextGrouping[f]&&a(this).jqGrid("showCol",b.groupField[f]);for(f=0;f<d.length;f++)b.visibiltyOnNextGrouping[f]=a("#"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(d[f])).is(":visible");this.p.groupingView=a.extend(this.p.groupingView,
e||{});b.groupField=d;a(this).trigger("reloadGrid")})},groupingRemove:function(d){return this.each(function(){"undefined"===typeof d&&(d=!0);this.p.grouping=!1;if(!0===d){for(var e=this.p.groupingView,b=0;b<e.groupField.length;b++)!e.groupColumnShow[b]&&e.visibiltyOnNextGrouping[b]&&a(this).jqGrid("showCol",e.groupField);a("tr.jqgroup, tr.jqfoot","#"+a.jgrid.jqID(this.p.id)+" tbody:first").remove();a("tr.jqgrow:hidden","#"+a.jgrid.jqID(this.p.id)+" tbody:first").show()}else a(this).trigger("reloadGrid")})},
groupingCalculations:{handler:function(a,e,b,f,c,h){var g={sum:function(){return parseFloat(e||0)+parseFloat(h[b]||0)},min:function(){return""===e?parseFloat(h[b]||0):Math.min(parseFloat(e),parseFloat(h[b]||0))},max:function(){return""===e?parseFloat(h[b]||0):Math.max(parseFloat(e),parseFloat(h[b]||0))},count:function(){""===e&&(e=0);return h.hasOwnProperty(b)?e+1:0},avg:function(){return g.sum()}};if(!g[a])throw"jqGrid Grouping No such method: "+a;a=g[a]();null!=f&&("fixed"==c?a=a.toFixed(f):(f=
