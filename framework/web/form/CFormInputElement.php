...
class CFormInputElement extends CFormElement
{
	...
	public function renderError()
	{
		$parent=$this->getParent();
                $widget = $parent->getActiveFormWidget();
		return $widget->error($parent->getModel(), $this->name, $this->errorOptions, $this->enableAjaxValidation, $this->enableClientValidation);
	}
