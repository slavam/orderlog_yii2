...
//        }
    ...
    public function actionGetDirectionsForSelect()
        {
			...
			$ret = CHtml::dropDownList('',null,CHtml::listData($model,'id', 'short_name'),array('empty' => '<Все>'));
    ...
    public function actionGetDataForGrid()  {
            ...
            $dataProvider = new CActiveDataProvider('Asset' , array(
            					'pagination'=>false, 
            					'criteria' => array(
            						'with' => array('block','assetGroup'),
//	            					'order' => 't.direction_id,block.name,assetGroup.name'))
