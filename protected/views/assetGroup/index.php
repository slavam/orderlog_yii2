...
//         { name : 'dir', index : 'dir', width : 50, editable: true, sortable:false, edittype:'select', editrules:{required:true, number:true}, editoptions: {dataUrl:'getDirectionsForSelect'}},
         { name : 'dir', index : 'dir', width : 50, editable: true, sortable:false, edittype: 'select', editrules:{required:true, number:true}, editoptions: {value: <?php echo Helpers::BuildEditOptions(Direction::model(),array('key'=>'id','value'=>'short_name'))?> }},
