...
$(function() {
    ...
    grid.jqGrid( {
        ...
        { name : 'supergroup', index : 'supergroup', width : 1, sortable:false }, 
        { name : 'group', index : 'group', width : 1, sortable:false }, 
        ...
        { name : 'code', index : 'code', width : 50, sortable:false }, 
        { name : 'article', index : 'article', width : 250, sortable:false }, 
        ],
        pager : '#pager',
        rowNum : 0,
